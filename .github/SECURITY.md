...
https://github.com/RealWhyKnot/OpenVR-PairDriver/security/advisories/new

I try to acknowledge new reports within 7 days and aim for an initial assessment within 14 days. There is no bug bounty.

## Scope

OpenVR-PairDriver is a OpenVR SteamVR driver. Reports are in scope when they involve unintended code execution, unsafe file writes, privilege boundary issues, local service exposure, or behavior that lets untrusted input compromise the user's machine or project.

...
Delete the flag file(s) for the feature(s) you want to disable from `<SteamVR runtime>\drivers\01openvrpair\resources\`:
...
To remove the driver entirely: delete `<SteamVR runtime>\drivers\01openvrpair\` while SteamVR is closed.

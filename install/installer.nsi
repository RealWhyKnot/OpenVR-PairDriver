...
Section "Install"
	...
	File "..\lib\fonts\Inter-Regular.ttf"
	File "..\lib\fonts\Inter-Medium.ttf"
	File "..\lib\fonts\Inter-SemiBold.ttf"
	File "..\lib\fonts\JetBrainsMono-Regular.ttf"
	File "..\lib\fonts\lucide.ttf"
	File "..\lib\fonts\LICENSE-Inter.txt"
	File "..\lib\fonts\LICENSE-JetBrainsMono.txt"
	File "..\lib\fonts\LICENSE-Lucide.txt"
	File "..\LICENSE"
...
Section "Uninstall"
	...
	Delete "$INSTDIR\Inter-Regular.ttf"
	Delete "$INSTDIR\Inter-Medium.ttf"
	Delete "$INSTDIR\Inter-SemiBold.ttf"
	Delete "$INSTDIR\JetBrainsMono-Regular.ttf"
	Delete "$INSTDIR\lucide.ttf"
	Delete "$INSTDIR\LICENSE-Inter.txt"
	Delete "$INSTDIR\LICENSE-JetBrainsMono.txt"

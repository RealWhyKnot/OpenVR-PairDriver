...
// LocalAppDataLow\OpenVR-WKPairDriver\Logs directory doesn't accumulate forever.
...
// Build %LocalAppDataLow%\OpenVR-WKPairDriver\Logs\driver_log.<date>T<time>.txt.
...
std::wstring BuildLogPath()
{
	...
	std::wstring dir = root + L"\\OpenVR-WKPairDriver";

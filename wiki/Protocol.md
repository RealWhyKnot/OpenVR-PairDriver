...
`protocol::Version = 15`, defined in [core/src/common/Protocol.h](https://github.com/RealWhyKnot/OpenVR-WKPairDriver/blob/main/core/src/common/Protocol.h). The handshake fails closed on mismatch -- a paired install where overlay and driver are different versions is rejected at connect time rather than silently misrouting request bytes.
